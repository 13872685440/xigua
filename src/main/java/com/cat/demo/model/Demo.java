...
@BatchSize(size = 50)
@DynamicInsert
public class Demo extends ProcessEntity{

	/**
	 * 
	 */
	private static final long serialVersionUID = 4428349071772070194L;
	...
	/** 页签关联使用 */
	@Column(length = 40)
	private String demo_tree_id;
	
	@Transient
	private String demo_tree_input;
	...
	public String getDemo_tree_id() {
		return demo_tree_id;
	}

	public void setDemo_tree_id(String demo_tree_id) {
		this.demo_tree_id = demo_tree_id;
	}

	public String getDemo_tree_input() {
		if(!StringUtil.isEmpty(this.demo_tree_id)) {
			DemoTree d = (DemoTree)getService().findById(DemoTree.class, this.demo_tree_id);
			return d.getInput();
		}
		return demo_tree_input;
	}

	public void setDemo_tree_input(String demo_tree_input) {
		this.demo_tree_input = demo_tree_input;
	}
